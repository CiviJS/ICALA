...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-content">
            ...
            <div class="nav-action">
                <a href="#" class="btn-accent">Donar Ahora</a>
            </div>
        </div>
    </nav>
        ...
        <section id="liderazgo">
            ...
            <div class="leadership-card">
                ...
                <div class="leadership-info">
                    ...
                    <p class="leader-subtitle">Fundadores y Guías del Ministerio ICALA desde 1997.</p>
                    <p>
    ...
    <!-- FOOTER -->
    <footer class="footer">
        <p>© 2025 Iglesia Cristiana Al Amparo Del Altísimo (ICALA). Todos los derechos reservados a Jeider Solano.</p>
